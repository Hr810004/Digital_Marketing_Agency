...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Retrieve form data
    $marketingType = $_POST['marketing_type'];
    $campaignObjectives = $_POST['campaign_objectives'];
    ...
    $query = "INSERT INTO digital_marketing (first_name, last_name, company_name, email, marketing_type, campaign_objectives, target_audience, budget, start_date, end_date) VALUES ('$firstName', '$lastName', '$companyName', '$email', '$marketingType', '$campaignObjectives', '$targetAudience', '$budget', '$startDate', '$endDate')";

    // Execute the query
    if (mysqli_query($conn, $query)) {
        // Form submission successful
        echo "<script>alert('Digital Marketing details submitted successfully. Our Team will contact you soon');</script>";
    } else {
...
<head>
    ...
    <title>Digital Marketing Form | GrowthGenius</title>
    ...
    <style>
        ...
        *::after {
        ...
        body{
            background: url(assets/images/digitalmarketing.jpg);
...
<body>
    <div class="wrapper">
        ...
        <!-- SEO Form Box -->
        <div class="form-box">
        <form action="digitalmarketingform.php" method="POST">
                ...
                <input type="text" id="marketing_type" class="input-field" name="marketing_type" required>

                <label for="campaign_objectives">Campaign Objectives:</label>
                <textarea id="campaign_objectives" class="input-field" name="campaign_objectives" required></textarea>

                <label for="target_audience">Target Audience:</label>
                <textarea id="target_audience" class="input-field" name="target_audience" required></textarea>

                <label for="budget">Budget for Marketing Campaign:</label>
